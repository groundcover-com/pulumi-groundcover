...
//				return err
//			}
//			ctx.Export("monitorExampleId", k8sPodCrashLooping.ID())
//			ctx.Export("monitorExampleYamlOutput", k8sPodCrashLooping.MonitorYaml)
//			return nil
//		})
//	}
//
...
type Monitor struct {
	...
	MonitorYaml pulumi.StringOutput `pulumi:"monitorYaml"`
}
...
func NewMonitor(ctx *pulumi.Context,
	...
	if args.MonitorYaml == nil {
		return nil, errors.New("invalid value for required argument 'MonitorYaml'")
	}
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Monitor
	err := ctx.RegisterResource("groundcover:index/monitor:Monitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitor(ctx *pulumi.Context,
	...
	var resource Monitor
	err := ctx.ReadResource("groundcover:index/monitor:Monitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type monitorState struct {
	// The monitor definition in YAML format.
	MonitorYaml *string `pulumi:"monitorYaml"`
}

type MonitorState struct {
	// The monitor definition in YAML format.
	MonitorYaml pulumi.StringPtrInput
}
...
type MonitorArgs struct {
	// The monitor definition in YAML format.
	MonitorYaml pulumi.StringInput
}
...
// The monitor definition in YAML format.
func (o MonitorOutput) MonitorYaml() pulumi.StringOutput {
	return o.ApplyT(func(v *Monitor) pulumi.StringOutput { return v.MonitorYaml }).(pulumi.StringOutput)
}
