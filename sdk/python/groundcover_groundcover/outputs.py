...
@pulumi.output_type
class MetricspipelineRules(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "addLabel":
            suggest = "add_label"
        elif key == "dropRegexes":
            suggest = "drop_regexes"
        elif key == "keepRegexes":
            suggest = "keep_regexes"
        elif key == "removeLabels":
            suggest = "remove_labels"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MetricspipelineRules. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MetricspipelineRules.__key_warning(key)
    ...
    def __init__(__self__, *,
                 add_label: Optional[Mapping[str, _builtins.str]] = None,
                 drop_regexes: Optional[Sequence[_builtins.str]] = None,
                 keep_regexes: Optional[Sequence[_builtins.str]] = None,
                 raw: Optional[_builtins.str] = None,
                 remove_labels: Optional[Sequence[_builtins.str]] = None):
        """
        :param Mapping[str, _builtins.str] add_label: Map of label key-value pairs to add to every metric.
        :param Sequence[_builtins.str] drop_regexes: List of regex patterns. Metrics whose **name** matches any pattern are dropped.
        :param Sequence[_builtins.str] keep_regexes: List of regex patterns. Only metrics whose **name** matches at least one pattern are kept. All others are dropped.
        :param _builtins.str raw: Raw VictoriaMetrics relabeling rules in YAML format for advanced use cases.
        :param Sequence[_builtins.str] remove_labels: List of label names to remove from every metric. Be careful with this setting as it can cause metrics amalgamation.
        """
    ...
    def add_label(self) -> Optional[Mapping[str, _builtins.str]]:
        """
    ...
    def drop_regexes(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def keep_regexes(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def remove_labels(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class SyntheticTestAssertion(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str source: What to assert on. All check types: `responseTime`. HTTP: `statusCode`, `responseHeader`, `jsonBody`, `responseBody`. SSL/TLS: `certificateValid`, `certificateExpiresIn`, `tlsVersion`, `chainValid`, `cipherSuite`. TCP: `tcpConnection`, `responseContains`. DNS: `dnsAnswer`.
