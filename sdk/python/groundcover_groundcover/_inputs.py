...
class SyntheticTestAssertionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source: What to assert on: `statusCode`, `responseTime`, `responseHeader`, `jsonBody`, `responseBody`.
        :param pulumi.Input[_builtins.str] property: Property path for header or JSON body assertions (e.g. `Content-Type` or `data.id`).
...
class SyntheticTestHttpCheckArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] method: HTTP method. Supported: `GET`, `POST`, `PUT`, `PATCH`, `DELETE`, `HEAD`, `OPTIONS`.
        :param pulumi.Input[_builtins.str] url: The URL to check (must include http:// or https://).
