...
export { RecurringSilenceArgs, RecurringSilenceState } from "./recurringSilence";
export type RecurringSilence = import("./recurringSilence").RecurringSilence;
export const RecurringSilence: typeof import("./recurringSilence").RecurringSilence = null as any;
utilities.lazyLoad(exports, ["RecurringSilence"], () => require("./recurringSilence"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "groundcover:index/recurringSilence:RecurringSilence":
                return new RecurringSilence(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("groundcover", "index/recurringSilence", _module)
