...
namespace GroundcoverCom.Groundcover
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/groundcover-com/pulumi-groundcover";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("GroundcoverCom.Groundcover.version.txt");
    ...
    internal sealed class GroundcoverResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GroundcoverResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
