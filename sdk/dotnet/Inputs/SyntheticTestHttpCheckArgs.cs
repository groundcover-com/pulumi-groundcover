...
namespace GroundcoverCom.Groundcover.Inputs
{
    ...
    public sealed class SyntheticTestHttpCheckArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("auth")]
        public Input<Inputs.SyntheticTestHttpCheckAuthArgs>? Auth { get; set; }

        /// <summary>
        /// HTTP request body.
        /// </summary>
        [Input("body")]
        public Input<Inputs.SyntheticTestHttpCheckBodyArgs>? Body { get; set; }
        ...
        public SyntheticTestHttpCheckArgs()
        {
        }
        public static new SyntheticTestHttpCheckArgs Empty => new SyntheticTestHttpCheckArgs();
    }
}
